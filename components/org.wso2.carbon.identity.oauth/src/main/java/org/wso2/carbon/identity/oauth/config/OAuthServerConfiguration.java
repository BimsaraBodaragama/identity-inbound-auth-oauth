...
public class OAuthServerConfiguration {
    ...
    /**
     * Returns whether to use the Entity ID as the issuer in the ID token.
     *
     * @return True if the service provider is configured to use the Entity ID as the issuer in the ID token,
     *         false otherwise.
     */
